...
export class TransactionTableComponent {
  ...
  gridOptions: GridOptions = {
    getRowStyle: (params) => {
      ...
      return isIncome ? { backgroundColor: oddRow ? '#e6f3e6' : '#f0f8f0' } : { backgroundColor: oddRow ? '#fce4e4' : '#fdf0f0' };
    }
  }


  constructor(private utilService: UtilService, private tagService: TagService) {
  }
